...
class LayoutActiveBooking extends StatelessWidget {
  final List<Booking> activeBooking;
  final Rx<AddHostVehicle?> vehicle = Rx<AddHostVehicle?>(null);
  ...
  Widget build(BuildContext context) {
    var filteredBookings = activeBooking.where((element) => element.bookingStatus == "Request Pending").toList();
