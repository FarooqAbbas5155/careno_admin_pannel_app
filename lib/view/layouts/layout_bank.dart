...
class LayoutBank extends StatelessWidget {
 List<WithdrawRequestModel> bankRequest;
  @override
  Widget build(BuildContext context) {
    return bankRequest.isNotEmpty? ListView.builder(
      scrollDirection: Axis.vertical,
      shrinkWrap: true,
      itemCount: bankRequest.length,
      itemBuilder: (BuildContext context, int index) {
        var withdraw = bankRequest[index];
        return Container(
